...
${duthaThemeCss}[data-theme="dark"] body{background:radial-gradient(circle at 6% 0,#1e3a8a 0,transparent 35%),radial-gradient(circle at 94% 16%,#312e81 0,transparent 32%),#070b18!important;color:#e2e8f0!important}[data-theme="dark"] .brand,[data-theme="dark"] h1,[data-theme="dark"] h2{color:#f8fafc!important}[data-theme="dark"] .card{background:#111827d9!important;border-color:#334155!important;box-shadow:0 18px 50px #0007!important}[data-theme="dark"] .channel{background:#0f172ad9!important;border-color:#334155!important;color:#e2e8f0!important}[data-theme="dark"] .channel.soon{background:#111827!important;color:#cbd5e1!important}[data-theme="dark"] .channel h2,[data-theme="dark"] .channel p{color:inherit!important}[data-theme="dark"] .muted{color:#94a3b8!important}[data-theme="dark"] .badge{background:#1e293b!important;color:#cbd5e1!important}[data-theme="dark"] .badge.green{background:#1e3a8a!important;color:#bfdbfe!important}[data-theme="dark"] .stat{background:linear-gradient(135deg,#1d4ed8,#7c3aed)!important}[data-theme="dark"] input,[data-theme="dark"] select{background:#0b1220!important;color:#f8fafc!important;border-color:#475569!important}[data-theme="dark"] button,[data-theme="dark"] .button{background:linear-gradient(135deg,#2563eb,#7c3aed)!important}[data-theme="dark"] .ghost{background:#1e293b!important;color:#bfdbfe!important}</style></head><body><div class="dutha-theme-corner">${themeButton}</div><main><div class="top"><div class="brand">Dutha WorkOps</div></div>${content}</main></body></html>`, { headers: headers() });
}
