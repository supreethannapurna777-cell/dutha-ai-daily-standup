...
${duthaThemeCss}.brand{background:linear-gradient(145deg,#172554,#2563eb,#7c3aed)!important}.shell{backdrop-filter:blur(28px)}[data-theme="dark"] body{background:radial-gradient(circle at 10% 0,#1e3a8a 0,transparent 34%),radial-gradient(circle at 90% 100%,#312e81 0,transparent 32%),#070b18!important}[data-theme="dark"] .shell{background:#111827e8!important;border:1px solid #334155}[data-theme="dark"] .form h1{color:#f8fafc!important}[data-theme="dark"] .muted,[data-theme="dark"] .note{color:#94a3b8!important}[data-theme="dark"] input{background:#0b1220!important;color:#f8fafc!important;border-color:#475569!important}[data-theme="dark"] button{background:linear-gradient(135deg,#2563eb,#7c3aed)!important}
