...
<section class="integrations"><article class="integration"><h2>WhatsApp</h2>${statusPill(whatsappReady, whatsappReady ? "Configured" : "Needs configuration")}<p class="muted">Pending ${readiness.whatsapp.pending} · Failed ${readiness.whatsapp.failed}</p></article><article class="integration"><h2>Microsoft Teams</h2>${statusPill(teamsReady, teamsReady ? "Configured" : "Needs configuration")}<p class="muted">Pending ${readiness.teams.pending} · Failed ${readiness.teams.failed}</p></article><article class="integration"><h2>Jira / Atlassian</h2>${statusPill(jiraReady, jiraReady ? "Configured" : "Needs API or webhook configuration")}<p class="muted">Pending ${readiness.jira.pending} · Failed ${readiness.jira.failed}</p></article></section>
