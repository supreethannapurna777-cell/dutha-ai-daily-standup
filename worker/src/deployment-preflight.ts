...
export function evaluateDeploymentPreflight(env: WorkerEnv): DeploymentPreflight {
		...
		["WhatsApp template language", env.WHATSAPP_TEMPLATE_LANGUAGE],
		["WhatsApp initial template", env.WHATSAPP_INITIAL_TEMPLATE_NAME],
		["WhatsApp reminder template", env.WHATSAPP_REMINDER_TEMPLATE_NAME],
		["WhatsApp availability template", env.WHATSAPP_AVAILABILITY_TEMPLATE_NAME],
		["WhatsApp meeting template", env.WHATSAPP_MEETING_TEMPLATE_NAME],
